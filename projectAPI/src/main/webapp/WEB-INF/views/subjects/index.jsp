    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <a href="/BanHang4App/admin/subjects/add" class="btn btn-primary">Add Subjects</a>
                <div class="card mb-4">
                            ...
                            <c:forEach var="subject" items="${listSubjects}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/BanHang4App/admin/subject/update?id=${subject.getId()}"><i
                                                class="fa fa-retweet" aria-hMaGVden="true"></i></a>
                                        <a href="/BanHang4App/admin/subject/delete?id=${subject.getId()}"

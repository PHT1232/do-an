        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <div style="width: 235px; margin-top: 15px; text-align: center; padding: 0px; height: 50px" class="btn btn-sm btn-white">
                                            <span style="
    margin-top: 5px;
    font-size: 20px;
    ...
    color: black;">Danh sách sinh viên</span>
        ...
        <div class="row d-flex">
            <c:forEach var="baiTapList" items="${baiTapLists}">
                <a style="width: 100%; margin-top: 15px; padding: 0px; height: 100px" class="btn btn-sm btn-white" href="/projectAPI_war/Teacher/chamDiem?id=${baiTapList.id}">
                    <div>

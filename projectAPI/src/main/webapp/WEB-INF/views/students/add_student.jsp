    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <a href="/BanHang4App/admin/students/add" class="btn btn-primary">Add Student</a>
                <div class="card mb-4">
                    <div class="card-body">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="/BanHang4App/admin/students/add_action"
                              method="post">
                            <table>
                                <tr>
                                    <td>ID:</td>
                                    <td><input type="text" name="id" class="form-control"
                                               value="${studentDTO.getId()}"/></td>
                                </tr>
                                <tr>
                                    <td>Name:</td>
                                    <td><input type="text" name="name" class="form-control"
                                               value="${studentDTO.getName()}"/></td>
                                </tr>
                                <tr>
                                    <td>Age:</td>
                                    <td><input type="text" name="age" class="form-control"
                                               value="${studentDTO.getAge()}"/></td>
                                </tr>
                                <tr>
                                    <td>Address:</td>
                                    <td><input type="text" name="address" class="form-control"
                                               value="${studentDTO.getAddress()}"/></td>
                                </tr>
                                <tr>
                                    <td>Avatar:</td>
                                    <td><input name="picture" class="form-control" value="${studentDTO.getPicture()}"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Phone Number:</td>
                                    <td><input type="text" name="sdt" class="form-control"
                                               value="${studentDTO.getSdt()}"/></td>
                                </tr>
                                <tr>

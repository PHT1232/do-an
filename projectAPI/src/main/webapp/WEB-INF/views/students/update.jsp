    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <a href="/BanHang4App/admin/students/add" class="btn btn-primary">Update Student</a>
                <div class="card mb-4">
                    <div class="card-body">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form:form modelAttribute="updateStudents"
                                   action="/BanHang4App/admin/students/update_action/${idStudent}"
                                   method="post">
                            <table>
                                <tr>
                                    <td>ID:</td>
                                ...
                                <tr>
                                    <td colspan="2"><input type="submit" class="btn btn-primary"/><a href="../students"

                ...
                <div class="card-body">
                    <table id="datatablesSimple">
                        ...
                        <c:forEach var="learning" items="${listLearning}"
                                   varStatus="status">
                            <tr>
                                <td>${learning.getId()}</td>
                                <td>${learning.getIdStudent()}</td>
                                <td>${learning.getIdMon()}</td>
                                <td>${learning.getIdTeacher()}</td>
                                <td>
                                    <a href="#"><i class="fa fa-eye" aria-hMaGVden="true"></i></a>
                                    <a href="/BanHang4App/admin/learning/update?id=${learning.getId()}"><i
                                            class="fa fa-retweet" aria-hMaGVden="true"></i></a>
                                    <a href="/BanHang4App/admin/learning/delete?id=${learning.getId()}"

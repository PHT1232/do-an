    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <a href="/BanHang4App/admin/classes/add" class="btn btn-primary">Add Classes</a>
                <div class="card mb-4">
                            ...
                            <c:forEach var="classes" items="${listClasses}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/BanHang4App/admin/students/update?id=${classes.getId()}"><i
                                                class="fa fa-retweet" aria-hMaGVden="true"></i></a>
                                        <a href="/BanHang4App/admin/students/delete?id=${classes.getId()}"

...
<%--                                    <input type="text" name="username" value="${username}">--%>
                    ...
                    <div class="row">
                        <div class="col">
                            <div style="cursor: pointer; width: 278px; margin-top: 15px; text-align: center; height: 35px; vertical-align: middle" class="btn btn-sm btn-white" onclick="submitForm()">

                    ...
                    <div class="navbar-body col-lg-12">
                        <ul class="navbar-nav flex-grow-1 col-lg-12">
                            ...
                            <li class="hs-has-sub-menu navbar-nav-item col-lg-2">
                                ...
                                <!-- Dropdown -->
                                <ul id="navLinkDashboardsDropdown" class="hs-sub-menu dropdown-menu dropdown-menu-lg hs-sub-menu-desktop-lg animated" aria-labelledby="dashboardsDropdown" style="min-width: 16rem; animation-duration: 300ms;">
                                    <li>
                ...
                <div class="col-lg-10">
                    ...
                    <div class="profile-cover">
                        <div class="profile-cover-img-wrapper">
                            <img id="profileCoverImg" class="profile-cover-img" src="<c:url value="/resource/img/img2.jpg"></c:url>" alt="Image Description">
...
<%--                            <span class="d-none d-sm-inline-block ml-1">Update your header</span>--%>
                    ...
                    <div class="text-center mb-5">
                      ...
                      <img id="avatarImg" class="avatar-img" src="<c:url value="/resource/img/img6.jpg"></c:url>" alt="Image Description">
                      ...
                      <span class="avatar-uploader-trigger">
                        ...
                        <h1 class="page-title">${name} <i class="tio-verified tio-lg text-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Top endorsed"></i></h1>
...
<%--                                    </button>--%>
                               ...
                               &quot;type&quot;: &quot;css-animation&quot;
                                        ...
                                        <div id="profileDropdown" class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-right mt-1 hs-unfold-hidden hs-unfold-content-initialized hs-unfold-css-animation animated hs-unfold-reverse-y" data-hs-target-height="243" data-hs-unfold-content=""
                                             data-hs-unfold-content-animation-in="slideInUp" data-hs-unfold-content-animation-out="fadeOut" style="animation-duration: 300ms;">
                    ...
                    <c:forEach items="${lsDTO}" var="lsDTO">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 text-secondary">
                                ...
                                <input type="text" value="${lsDTO.sdt}" name="phone" id="phoneInput" style="display: none;" class="form-control"/>
                            </div>
                        </div>
                        <br/>
                        <div class="row">
                            ...
                            <div class="col-sm-9 text-secondary" >
                                ...
                                <input type="text" value="${lsDTO.address}" name="address" id="addressInput" style="display: none;" class="form-control"/>
                            </div>
                        </div>
                    </c:forEach>

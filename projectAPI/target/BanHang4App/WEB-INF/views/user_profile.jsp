...
<%--                            <div class="card-body">--%>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        ...
                                        <input type="text" value="${lsDTO.sdt}" id="phoneInput" style="display: none;" class="form-control"/>
                                    </div>
                                </div>
                                <br/>
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary" >
                                        ...
                                        <input type="text" value="${lsDTO.address}" id="addressInput" style="display: none;" class="form-control"/>
                                    </div>
                                </div>
                            </c:forEach>
                            <!-- End Card -->
